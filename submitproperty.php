...
if(isset($_POST['add']))
{
	...
	$sql="insert into property (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,feature,pimage,uid,status,totalfloor, isFeatured)
	values('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$feature','$aimage','$uid','$status','$totalfloor', '$isFeatured')";
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row" style="margin-top:85px">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center" style="font-family: sans-serif;">Submit Property</h2>
                        </div>
					</div>
								...
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<input type="submit" value="Submit Property" class="btn btn-info"name="add" style="margin-left:460px; background-color: #29524a; border-radius:30px">
...
<script src="JS/js/tinymce/init-tinymce.min.js"></script>
<!--jQuery Layer Slider --> 
