...
<body>
    ...
    <div class="navbar" id="headerfixed" style="position:fixed; width:100%; height:82px">
        <div class="nav">
            <div class="navlogo">
            ...
            <div class="navsubmit">
                <button id="navbutton" style="color:white; height:40px"><a href="submitproperty.php" style="color:white;">Submit Property</a></button>
            </div>
        </div>
    </div>
